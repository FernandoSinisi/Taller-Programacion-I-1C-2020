...
void CargadorDeConfiguracion::cargar(int argc, char* argv[]) {
    ...
    int cantEnemigo1_1 =  atoi( (char*) (json_res["configuration"]["game"]["enemies"][0]["quantity_1"].asString().c_str()));
    int cantEnemigo1_2 =  atoi( (char*) (json_res["configuration"]["game"]["enemies"][0]["quantity_2"].asString().c_str()));
    int cantEnemigo2_1 =  atoi( (char*) (json_res["configuration"]["game"]["enemies"][1]["quantity_1"].asString().c_str()));
    int cantEnemigo2_2 =  atoi( (char*) (json_res["configuration"]["game"]["enemies"][1]["quantity_2"].asString().c_str()));
