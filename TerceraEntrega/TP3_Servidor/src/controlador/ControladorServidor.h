...
public:
    ...
    /// Recibe nombre y password de los clientes y los guarda en cada uno de sus jugadores/personajes_vivos
    ...
    /// Envia los estados de todos los elementos (personajes_vivos, enemigos, fondo, etc) a los clientes
    void enviarEstados();
    ...
    void esperarTiempo(const unsigned int segs);

    void esperarTiempoConLock(const unsigned int segs);
};
