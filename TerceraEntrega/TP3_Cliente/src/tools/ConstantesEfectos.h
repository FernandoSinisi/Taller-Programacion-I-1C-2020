...
static std::vector<int> CORRECCIONES_JEFES ={CORRECCION_X_JEFE_1, CORRECCION_Y_JEFE_1};
static std::vector<int> EXPLOSIONES_JEFES ={ANCHO_EXPLOSION_JEFE_1, ALTO_EXPLOSION_JEFE_1};
