#ifndef CLIENTE_CONSTANTESMENSAJES_H
#define CLIENTE_CONSTANTESMENSAJES_H
...
static const std::string PRE_EFECTOS = "efecto";
...
static const std::string PRE_TABLAS_PUNTAJE = "tabla_puntajes";
static const std::string PRE_ESPERANDO_RECONEXION = "esperando_desconectados";
...
#endif //CLIENTE_CONSTANTESMENSAJES_H
