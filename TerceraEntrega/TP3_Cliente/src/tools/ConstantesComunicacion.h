...
// Cerca de 5 segundos, para el caso de que SE PIERDA la comunicación
// con el servidor, ya que en el caso de que el servidor se cierre (shutdown)
// se manda el "mensaje vacío" a nivel sockets para indicar esto.
static constexpr unsigned int TIMEOUT_RECEPCION_SV = 400000;
