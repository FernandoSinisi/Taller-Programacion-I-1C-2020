...
int Cliente::recibir(void* buffer){
    ...
    //Veo cuantos bytes me va a mandar el TP3_Cliente
    ...
    if (socket_esta_conectado){
        //La cantidad de bytes que me mando el TP3_Cliente
...
int Cliente::bytesARecibir(void* amount_of_bytes){
    ...
    //El TP3_Cliente en su mensaje manda en los primeros 4 bytes el uint16_t que
    ...
    if (socket_esta_conectado){
        //La cantidad de bytes que me mandó el TP3_Cliente
        return (int)recv_bytes;
    }
