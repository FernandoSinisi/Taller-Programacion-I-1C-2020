...
CartelVista::CartelVista(SDL_Renderer *renderizador) {
    ...
    SDL_Texture *cartel_3 = crearTextura(RUTA_FONDO_1_FIN, this->renderizador);
    SDL_Texture *cartel_4 = crearTextura(RUTA_FONDO_2_INICIO, this->renderizador);
    SDL_Texture *cartel_5 = crearTextura(RUTA_FONDO_2_FIN, this->renderizador);
    ...
    this->carteles.push_back(cartel_5);
